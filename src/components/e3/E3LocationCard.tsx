...
export function E3LocationCard({ location }: { location: Location }) {
  return (
    <Link
      to="/locations/$id"
      params={{ id: location.id }}
      className="block rounded-2xl border border-border bg-card p-5 transition-all hover:-translate-y-0.5 hover:border-e3-purple/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
