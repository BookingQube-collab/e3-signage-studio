...
export function E3ScreenCard({
  ...
  return (
    <div
      className={cn(
        "relative rounded-2xl border border-border bg-card transition-all hover:-translate-y-0.5 hover:border-e3-purple/40",
        className,
      )}
    >
      <Link
      ...
      {overflow ? <div className="absolute right-3 top-12 z-10">{overflow}</div> : null}
    </div>
  );
}
